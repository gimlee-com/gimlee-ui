  ...
  "en-US": {
    translation: {
      ...
      "pricing": {
        ...
        "fixedCryptoDesc": "I want to set an explicit price in each cryptocurrency I accept.",
        "pegged": "Pegged Price",
        ...
        "fixedPricesLabel": "Set a price for each cryptocurrency",
        "fixedPricesHint": "Buyers will pay the exact amount in their chosen cryptocurrency.",
        "priceIn": "Price in {{currency}}",
        "atLeastOneCurrencyRequired": "Set a price for at least one cryptocurrency.",
      ...
      "admin": {
        ...
        "reports": {
          ...
          "detail": {
            ...
            "noResolution": "Pending",
            "dateSubmitted": "Date Submitted",
            "resolvedBy": "Resolved by",
            "assign": "Assign",
            "addNote": "Add Note",
            "resolveOrDismiss": "Resolve / Dismiss",
            "description": "Description",
            "targetSnapshot": "Target Snapshot",
            "siblingReports": "Sibling Reports",
            "noTimeline": "No timeline entries.",
            "assignSuccess": "Report assigned successfully.",
            "noteAdded": "Note added successfully.",
            "resolveSuccess": "Report resolved successfully.",
            "hideSiblings": "Hide sibling reports",
            "showSiblings": "Show sibling reports",
            "viewAd": "View Ad",
            "viewUser": "View User",
  ...
  "pl-PL": {
    translation: {
      ...
      "pricing": {
        ...
        "fixedCryptoDesc": "Chcę ustawić dokładną cenę w każdej akceptowanej kryptowalucie.",
        ...
        "fixedPricesLabel": "Ustaw cenę dla każdej kryptowaluty",
        "fixedPricesHint": "Kupujący zapłacą dokładną kwotę w wybranej kryptowalucie.",
        "priceIn": "Cena w {{currency}}",
        "atLeastOneCurrencyRequired": "Ustaw cenę dla co najmniej jednej kryptowaluty.",
      ...
      "admin": {
        ...
        "reports": {
          ...
          "detail": {
            ...
            "noResolution": "Oczekujące",
            "dateSubmitted": "Data zgłoszenia",
            "resolvedBy": "Rozwiązane przez",
            "assign": "Przypisz",
            "addNote": "Dodaj notatkę",
            "resolveOrDismiss": "Rozwiąż / Odrzuć",
            "description": "Opis",
            "targetSnapshot": "Migawka obiektu",
            "siblingReports": "Powiązane zgłoszenia",
            "noTimeline": "Brak wpisów na osi czasu.",
            "assignSuccess": "Zgłoszenie przypisane pomyślnie.",
            "noteAdded": "Notatka dodana pomyślnie.",
            "resolveSuccess": "Zgłoszenie rozwiązane pomyślnie.",
            "hideSiblings": "Ukryj powiązane zgłoszenia",
            "showSiblings": "Pokaż powiązane zgłoszenia",
            "viewAd": "Zobacz ogłoszenie",
            "viewUser": "Zobacz użytkownika",
            "viewConversation": "Zobacz konwersację",
            "onAd": "w ogłoszeniu {{adId}}",
            "snapshotField": {
              "title": "Tytuł",
              "description": "Opis",
              ...
              "text": "Treść",
              "senderId": "Nadawca",
              "conversationId": "Konwersacja",
              "adId": "Powiązane ogłoszenie",
              "authorId": "Autor"
            }
          }
        }
