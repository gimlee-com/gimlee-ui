...
describe('mapSuggestedActionToUrl', () => {
  ...
  it('should map ADMIN_REPORT_DETAILS to /admin/reports/:id', () => {
    ...
    expect(mapSuggestedActionToUrl(action)).toBe('/admin/reports/123');
  });
